...
assert((5265824) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 5265824);
assert(16777216 >= TOTAL_STACK, 'INITIAL_MEMORY should be larger than TOTAL_STACK, was ' + 16777216 + '! (TOTAL_STACK=' + TOTAL_STACK + ')');
assert(16777216 % WASM_PAGE_SIZE === 0);
assert(2147483648 % WASM_PAGE_SIZE == 0);
assert(buffer.byteLength === 16777216);
...
// {{PRE_LIBRARY}}
  ...
  function _upload_unicode_char_to_texture(unicodeChar, charSize, bold, r, g, b, outCharWidth, outCharBaseline, outTextureWidth, outTextureHeight) {
...
var _main,_malloc,stackSave,stackRestore,stackAlloc,_free,dynCall_jiji,__growWasmMemory;
